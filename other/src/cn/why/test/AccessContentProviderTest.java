...
public class AccessContentProviderTest extends AndroidTestCase {
	...
	public void testInsert() throws Exception{		                               
		...
		//访问内容提供者ContentResolver，通过上下文得到
	...
	public void testDelete() throws Exception{
		Uri uri = Uri.parse("content://cn.why.providers.personprovider/person/20");
		ContentResolver resolver = this.getContext().getContentResolver();
		resolver.delete(uri, null, null);
	}
	
	public void testUpdate() throws Exception{
		Uri uri = Uri.parse("content://cn.why.providers.personprovider/person/1");
		ContentResolver resolver = this.getContext().getContentResolver();
		ContentValues values = new ContentValues();
